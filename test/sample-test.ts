...
describe("NFTMarket", function () {
    it("Should create and execute market sales", async function () {
        ...
        let listPrice: BigNumber = await nftMarketplace.getListingPrice()
        let listingPrice: string = listPrice.toString()
        ...
        let itemsClean : object[] = await Promise.all(items.map(async i => {
